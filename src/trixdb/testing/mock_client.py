...
@dataclass
class MockTrixDB:
    """Mock TrixDB client for synchronous testing.
...
@dataclass
class MockAsyncTrixDB:
    """Mock TrixDB client for asynchronous testing.

    Example:
        >>> from trixdb.testing import MockAsyncTrixDB, create_mock_memory
        >>>
        >>> async def test_my_service():
        ...     mock_client = MockAsyncTrixDB()
        ...
        ...     # Configure mock responses
        ...     mock_mem = create_mock_memory(content="Test")
        ...     mock_client.memories.mock_create(mock_mem)
