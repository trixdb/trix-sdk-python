...
Example:
    ...
    >>> from trixdb import configure_telemetry
    >>>
...
class TelemetryConfig:
    ...
    Attributes:
        ...
        span_name_prefix: Custom span name prefix (default: 'trixdb')
