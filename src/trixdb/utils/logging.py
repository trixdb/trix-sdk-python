...
@dataclass
class LogConfig:
    """Configuration for TrixDB logging.
...
def setup_logging(config: Optional[LogConfig] = None) -> logging.Logger:
    ...
    Example:
        >>> from trixdb.utils.logging import setup_logging, LogConfig, LogLevel
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    Args:
        name: Logger name. Defaults to 'trixdb'.
    ...
    """
    return logging.getLogger(name or "trixdb")
